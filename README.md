...
- `Space`: Jump
- `R`: Reset/restart level (including after reaching the exit)
...
**Player System**
- Input: `A/D` or arrows to move, `Space` to jump, `R` to reset.
- Physics: gravity, ground/platform collision, jump arc.
- State flags: alive/won.

**Level System**
- Start area.
- Platform sequence with gap and spike hazard.
